...
export default class Photo extends Component {
  ...
  componentDidMount() {
    //console.log("Mounted photo-browser photo component with source " + this.state.uri);
  }

  componentWillUnmount() {
    //console.log("Unmounting photo component with source " + this.state.uri);
  }
/*
  componentWillReceiveProps(nextProps) {
    console.log("Photo component received  new props");
  ...
  render() {
    const { resizeMode, width, height, uri } = this.props;
