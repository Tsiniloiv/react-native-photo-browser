...
export default class PhotoBrowser extends React.Component {
  ...
  static propTypes = {
    ...
    /*
     * Whether to display image delete button on bottom toolbar
     */
     displayDeleteButton: PropTypes.bool,

     /*
      * Whether to display video play/pause button on bottom toolbar.
      */
    ...
    /*
     * Whether to display image camera button on top toolbar
     */
    ...
    /*
     * Whether to display image sidebar button on top toolbar
     */
    displaySideBarButton: PropTypes.bool,

    // Called when sidebar button is pressed
    onSideBar: PropTypes.func,

    // Called when delete button is pressed for a media
  ...
  componentWillReceiveProps(nextProps) {
    ...
    //console.log("photo-browser receiving props: ");
  ...
  _onGridPhotoTap(index) {
    //console.log("Tapped grid photo " + index);
    //console.log(this);
  ...
  _toggleFullScreen(display: boolean) {
    //console.log("_toggleFullScreen called");
    this.setState({
    ...
    return (
      <View style={[styles.container, {
        ...
        <TopBarComponent
          ...
          onSideBar={onSideBar}
          onCamera={onCamera}
          onGrid={this._onGridButtonTap}
          displayGridButton={this.state.isFullScreen}
        />
      </View>
    );
  }
