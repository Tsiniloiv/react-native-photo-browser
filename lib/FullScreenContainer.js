...
export default class FullScreenContainer extends React.Component {
  ...
  _updatePageIndex(index) {
    ...
    if(this.props.mediaList(this.state.index).type === 'video') {
      this.setState({
        currentIndex: index,
        displayPlayButton: true,
        currentMedia: this.props.mediaList[index],
      });
    } else if (this.props.mediaList[this.state.index].type !== 'video') {
      this.setState({
        currentIndex: index,
        displayPlayButton: false,
        currentMedia: this.props.mediaList[index],
  ...
  _onPlayButtonTapped() {
    ...
    console.log(this.refs.photoRefs[this.state.currentIndex]);
    //this.refs.photoRefs[index]._playOrPauseVideo();
  }
    ...
    if(Platform.OS === 'ios') {
      ...
      return (
        <Swiper
          ...
          showsPagination={this.state.controlsDisplayed}
          style={styles.flex}
          loop={false}
          index={this.state.currentIndex}
          loadMinimal
